 ...
 */
final class Version20231110115228 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD main_image_id INT DEFAULT NULL, DROP main_image');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD main_image VARCHAR(255) NOT NULL, DROP main_image_id');
    }
}
